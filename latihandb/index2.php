	...
	<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
	  ...
	  <div class="collapse navbar-collapse" id="navbarNavDropdown">
	    <ul class="navbar-nav">
	      ...
	      <li class="nav-item">
	        <a class="btn btn-dark" href="form-daftar2.php">Daftar Baru</a>
	      </li>
	      <li class="nav-item">
	        <a class="btn btn-dark" href="list-siswa2.php">List Pendaftar</a>
	      </li>
	      <li class="nav-item">
